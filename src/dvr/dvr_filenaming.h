...
/* TODO
dvr_rec.c: pvr_generate_filename
dvr_db.c: dvr_make_title
*/

/**
 * Advanced filenaming declarations
 */
...
int dvr_filenaming_advanced_generate(char *destination, size_t max_size, dvr_filename_scheme_advanced_t *scheme, struct dvr_entry *de);
...
int dvr_filenaming_advanced_set_regex_maxsize(dvr_filename_scheme_advanced_t *scheme, int size);
